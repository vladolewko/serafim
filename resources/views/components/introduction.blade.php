    ...
    <div class="w-full px-4 sm:px-0 lg:w-[76%] lg:mx-auto">
        <div class="flex flex-col lg:flex-row  py-8 lg:py-0">
            <div class="w-full lg:w-[60%] mb-8 lg:mb-0 flex flex-col justify-center gap-3">
                ...
                <div class="flex lg:gap-10 flex-col sm:flex-row sm:gap-0">
                    <!-- <button
                        class="hidden lg:block bg-yellow-400 px-6 py-3 w-3/6 rounded-lg flex items-center justify-center text-black text-lg lg:text-xl font-semibold knowledgePackBtn" data-target="why_important">
                        <div class="flex items-center justify-between w-4/5">
                            <img class="" src="{{ asset('img/icon_book.png') }}" alt="">
                            <span class="">комплекти знань</span>
                        </div>
                    </button> -->
                    <button
