<div class="lg:w-5/6 xl:w-4/6 mx-auto my-72 section" id="knowledge_pack">
    <div class="flex">
        <div class="text-center mx-auto">
            <p class="text-2xl font-bold">Обери свій <span class="text-yellow-400"> комплект знань!</span>
            </p>
            <p class="text-sm text-slate-500 w-5/6 mx-auto">Замовляй свій набір та будь захищеним знанями...</p>
        </div>
    ...
    <div id="indicators-carousel" class="relative w-full mb-20" data-carousel="static">
        ...
        <div class="relative overflow-hidden rounded-lg h-[500px] w-full">
            <!-- Item 1 -->
