<div
    class="w-full px-1 sm:px-6 xl:w-4/6 mx-auto my-12 sm:my-20 lg:my-60 flex flex-col xl:flex-row justify-between gap-8 lg:gap-0">
    <!-- Ліва частина -->
    <div class="w-full lg:w-5/6 lg:mx-auto xl:w-3/5">
        <p class="text-xl sm:text-3xl lg:text-4xl font-bold text-center">
            Навіщо я створив <span class="text-yellow-400">"serafim.info"?</span>
        </p>
        <p class="text-xs sm:text-xl text-slate-600 mt-1 text-center">
    ...
    <div class="w-full xl:w-2/5 flex flex-col justify-end items-center space-y-6">
        <p class="text-lg sm:text-xl text-slate-600 text-center ">Я особисто пройшов через:</p>
        <div class="w-full sm:w-10/12 lg:w-9/12">
            <div
                class="border border-blue-400 rounded-xl px-3 sm:px-8 py-3 text-sm sm:text-lg lg:text-lg font-bold text-center">
            ...
            <div
                class="border border-blue-400 rounded-xl px-3 sm:px-8 py-3 text-sm  sm:text-lg lg:text-lg font-bold text-left">
        ...
        <p class="text-base sm:text-xl text-slate-600 my-5 text-center w-11/12">
        ...
        <div class="flex justify-between items-center w-11/12 gap-3">

            <img class="w-[100px] h-[100px]" src="{{ asset('img/mission.svg') }}" alt="">
