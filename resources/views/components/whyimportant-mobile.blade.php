    ...
    <div class="w-full lg:w-5/12">
        ...
        <div class="flex gap-1 justify-start mt-0 lg:mt-8 flex-wrap ">
            ...
            @foreach($applyings as $key => $value)
                <div class="flex flex-1 items-center justify-evenly gap-1 bg-blue-400 rounded-lg px-1 py-2 radio-div">
                    <input id="checkbox-{{ $key }}"
                            class="w-2 h-2 cursor-pointer rounded-[3px] text-blue-400 bg-white"
                            name="options"
                            type="radio"
                            value="{{ $key }}"
        ...
        <div
            class="flex flex-col sm:flex-row justify-between lg:justify-end mt-3 lg:my-5 items-center gap-4 lg:gap-5">
            <div class="text-black text-2xl lg:text-4xl">
                <span class="text-yellow-400" id="price">600</span> грн
            </div>
            <a href="" id="productHref"
                class="w-full text-center bg-yellow-400 px-6 py-3 rounded-lg text-black text-lg lg:text-xl font-semibold">замовити</a>
        </div>
    </div>

        <!-- Change text -->
        <div class="border border-blue-400 rounded-lg p-4 mt-6">
