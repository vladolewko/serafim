            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                <form action="{{ route('admin.products.update') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="px-6 py-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="md:col-span-1">
                                <label for="description"
                                       class="block text-sm font-medium text-gray-700 mb-2">Опис</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="md:col-span-1">
                                <label for="books_quantity" class="block text-sm font-medium text-gray-700 mb-2">Кількість
                                    книг</label>
                                <p class="text-sm text-gray-500">Число книг в комплекті</p>
                            </div>
                            <div class="md:col-span-2">
                                <input type="number" id="books_quantity" name="books_quantity"
                                       value="{{ $product->books_quantity }}" required
                                       class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="md:col-span-1">
                                <label for="dimension"
                                       class="block text-sm font-medium text-gray-700 mb-2">Розміри</label>
                                <p class="text-sm text-gray-500">Розмір(довжина, ширина та висота в сантиметрах)</p>
                            </div>
                            <div class="md:col-span-2">
                                <input type="text" id="length" name="length" value="{{ $product->length }}" required
                                       class="block w-full px-3 mb-2 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="md:col-span-1">
                                <label for="for_whom" class="block text-sm font-medium text-gray-700 mb-2">Для кого
                                    призначено</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="md:col-span-1">
                                <label for="appointment" class="block text-sm font-medium text-gray-700 mb-2">Призначення
                                    комплекту</label>
                                <p class="text-sm text-gray-500">Для яких цілей призначений</p>
                            </div>
                            <div class="md:col-span-2">
                                <input type="text" id="appointment" name="appointment"
                                       value="{{ $product->appointment }}" required
                                       class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="md:col-span-1">
                                <label for="applying"
                                       class="block text-sm font-medium text-gray-700 mb-2">Категорія</label>
