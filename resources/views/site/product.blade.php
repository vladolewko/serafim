    ...
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col lg:flex-row gap-6 lg:gap-8 lg:justify-between">
            ...
            <div class="w-full lg:w-6/12">
                ...
                <div class="bg-gray-200 w-full h-64 sm:h-80 lg:h-[548px] rounded-lg mb-4"></div>
            ...
            <div class="w-full lg:w-5/12">
                ...
                <div class="mb-6">
                    <h2 class="text-2xl sm:text-3xl font-bold mb-2">комплект громадянина</h2>
                ...
                <div class="mb-6">
                    <p class="text-base sm:text-lg lg:text-xl lg:w-[90%] leading-relaxed">
                        Цей набір створено ветераном, який особисто пройшов через свавілля системи і переміг.
                        У ньому — не суха теорія, а перевірені інструкції, які допомогли відстояти свої права в реальних судах.
                    </p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="flex flex-wrap gap-2 text-sm">
                        <div class="border-2 border-blue-400 rounded-lg py-1 px-3 ">Військовослужбовці ЗСУ</div>
                        <div class="border-2 border-blue-400 rounded-lg py-1 px-3 ">Військовослужбовці ТРО</div>
                        <div class="border-2 border-blue-400 rounded-lg py-1 px-3 ">добровольці</div>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="flex flex-wrap gap-2 text-sm">
                        <div class="border-2 border-blue-400 rounded-lg py-2 px-3  flex-grow sm:flex-grow-0">
                            Покрокові інструкції щодо оформлення статусу УБД, інвалідності, компенсацій.
                        </div>
                        <div class="border-2 border-blue-400 rounded-lg py-2 px-3 ">
                            Як подати позов до державних структур та виграти справу.
                        </div>
                        <div class="border-2 border-blue-400 rounded-lg py-2 px-3">Шаблони документів</div>
                        <div class="border-2 border-blue-400 rounded-lg py-2 px-3">Пояснення термінів</div>
                        <div class="border-2 border-blue-400 rounded-lg py-2 px-3">Посилання на актуальні закони</div>
                    </div>
                </div>
