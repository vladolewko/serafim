...
<div class="flex flex-col lg:flex-row w-full px-4 sm:px-6 lg:w-5/6 xl:w-4/6 lg:mx-auto lg:justify-between my-16 lg:my-72 gap-8" id="wt_knowledge_pack">
    <div class="w-full lg:w-5/12">
        <div class="mb-6">
    ...
    <div class="w-full lg:w-5/12 flex flex-col justify-center gap-8 lg:gap-10">
        <div class="flex justify-center items-center">
            <div class="border border-blue-400 rounded-lg flex flex-col items-center p-3 h-20 w-20 lg:h-24 lg:w-24 gap-1">
                <!-- <div class="w-8 h-8 lg:w-10 lg:h-10 bg-blue-200 rounded"></div> -->
                    <img class="h-[42px] w-[42px]" src="{{ asset('img/constitution.svg') }}" alt="constitution img">
        ...
        <div class="flex lg:justify-start justify-center items-center">
            <div class="border border-blue-400 rounded-lg flex flex-col items-center p-3 h-20 w-20 lg:h-24 lg:w-24 gap-2">
                <!-- <div class="w-8 h-8 lg:w-10 lg:h-10 bg-blue-200 rounded"></div> -->
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4">
        <div class="flex flex-col items-center text-center space-y-3">
            ...
            <p class="text-xs lg:text-sm text-gray-600">
                Першим кроком рекомендується звернутися зі скаргою до свого безпосереднього командира або начальника.
            </p>
        </div>
        <div class="flex flex-col items-center text-center space-y-3">
            ...
            <p class="text-xs lg:text-sm text-gray-600">Міноборони забезпечує цілодобову «гарячу лінію»</p>
        </div>
        <div class="flex flex-col items-center text-center space-y-3">
            <img class="w-20 h-20" src="{{ asset('img/commissioner.png') }}" alt="commissioner img">
            <p class="underline font-semibold text-sm lg:text-base">Уповноважений ВР України з прав людини</p>
        ...
        <div class="flex flex-col items-center text-center space-y-3">
            ...
            <p class="underline font-semibold text-sm lg:text-base">Військова служба правопорядку (ВСП)</p>
...
<div class="hidden lg:block w-full px-4 sm:px-6 lg:w-5/6 xl:w-4/6 lg:mx-auto my-16 lg:my-72">
    <div class="mb-10">
        <p class="text-2xl xl:text-4xl font-bold">Кожен українець <span class="text-yellow-400">повинен розуміти</span>, як подавати</p>
    ...
    <div id="indicators-carousel" class="relative w-full" data-carousel="static" >
            ...
            <div class="hidden duration-700 ease-in-out bg-white" data-carousel-item>
                <div class="flex gap-2 my-16 justify-center">
                    ...
                    <div class="flex flex-col items-center w-1/5 gap-1">
                        ...
                        <a class="flex text-solate-500" href="tel:1512"> <img src="{{ asset('img/phone.svg') }}" alt="phone img"> 1512 </a>
                    ...
                    <div class="flex flex-col items-center w-1/5 gap-1">
                        ...
                        <a class="flex text-solate-500" href="tel:0-800-50-17"> <img src="{{ asset('img/phone.svg') }}" alt="phone img"> 0 800 50 17 </a>
                    ...
                    <div class="flex flex-col items-center w-1/5 gap-1">
                        ...
                        <a class="flex text-solate-500" href="tel:(044) 454-73-08"> <img src="{{ asset('img/phone.svg') }}" alt="phone img"> (044) 454-73-08 </a>
        ...
        <div class="absolute z-30 flex -translate-x-1/2 space-x-0 rtl:space-x-reverse left-1/2 bottom-[-20px] w-full justify-center">
            <button type="button" class="w-[30%] h-[1px] rounded-full  slide_button" aria-current="true" aria-label="Slide 1" data-carousel-slide-to="0"></button>
            <button type="button" class="w-[30%] h-[1px] rounded-full  slide_button" aria-current="false" aria-label="Slide 2" data-carousel-slide-to="1"></button>
            <button type="button" class="w-[30%] h-[1px] rounded-full  slide_button" aria-current="false" aria-label="Slide 3" data-carousel-slide-to="2"></button>
        </div>
        <!-- Slider controls -->
    ...
    <div class="w-full px-4 sm:px-6 lg:w-4/6 lg:mx-auto">
        <div class="flex flex-col lg:flex-row gap-8 lg:justify-between">
            <div class="w-full lg:w-5/12 flex justify-center xl:justify-start items-center">
                <div class="rounded-xl inline-block h-min bg-gradient-to-t from-blue-300 to-white overflow-hidden">
            ...
            <div class="flex flex-col w-full lg:w-5/12 text-center lg:text-left">
                <div>
                    ...
                    <div class="mb-6">
                        <p class="text-base lg:text-lg">Моренець: <span class="font-bold">Євгеній Борисович</span></p>
                ...
                <div class="mt-6 lg:mt-8 italic text-base lg:text-lg">
                    "Війна — це не лише передова. Це ще й боротьба за права, за людську гідність і проти беззаконня,
...
<!-- Why Created Section -->
<div class="w-full px-4 sm:px-6 xl:w-4/6 mx-auto my-12 sm:my-20 lg:my-60 flex flex-col xl:flex-row justify-between gap-8 lg:gap-0">
    <!-- Ліва частина -->
    <div class="w-full lg:w-5/6 lg:mx-auto xl:w-[51.5%]">
        ...
        <p class="text-lg sm:text-xl text-slate-600 my-5">
            Усе почалося з того, що прийшовши на службу я сам собі створив комплект правових знань — щоб розуміти, як діяти в умовах служби, тиску чи порушень. І цей комплект мені реально допоміг.
        </p>
    ...
    <div class="w-full xl:w-3/5 flex flex-col justify-end items-center space-y-6">
        ...
        <div class="w-full sm:w-10/12 lg:w-9/12">
            <div class="border border-blue-400 rounded-xl px-6 sm:px-8 py-3 text-base sm:text-lg lg:text-lg font-bold text-left">
            ...
            <div class="border border-blue-400 rounded-xl px-6 sm:px-8 py-3 text-base sm:text-lg lg:text-lg font-bold text-left">
                приймав участь в бойових діях на сході, де служив пліч-о-пліч з тими, кому потрібен не лише автомат, а й знання
            </div>
        </div>
    </div>
</div>
...
<div class="w-full px-4 sm:px-6 lg:w-4/6 mx-auto my-12 sm:my-20 lg:my-60" id="social">
    ...
    <div class="w-full flex justify-end">
        <div class="border border-blue-400 rounded-xl px-6 sm:px-10 py-3 font-bold w-full sm:w-10/12 lg:w-6/12 text-center text-base sm:text-lg">
